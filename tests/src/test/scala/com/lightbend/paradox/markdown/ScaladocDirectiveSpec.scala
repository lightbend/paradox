...
class ScaladocDirectiveSpec extends MarkdownBaseSpec {
  ...
  def renderedMd(url: String, title: String, name: String, prefix: String = "", suffix: String = "") =
    html(
      Seq(prefix, """<p><a href="""", url, """" title="""", title, """"><code>""", name, """</code></a></p>""", suffix)
        .mkString("")
    )
  ...
  "Scaladoc directive" should "create links using configured URL templates" in {
    markdown("@scaladoc[Model](org.example.Model)") shouldEqual
      html(
        """<p><a href="http://example.org/api/0.1.2/org/example/Model.html" title="org.example.Model"><code>Model</code></a></p>"""
      )
  }
  ...
  it should "create accept digits in package names" in {
    markdown("@scaladoc[ObjectMetadata](akka.s3.ObjectMetadata)") shouldEqual
      html(
        """<p><a href="http://doc.akka.io/api/akka/2.4.10/akka/s3/ObjectMetadata.html" title="akka.s3.ObjectMetadata"><code>ObjectMetadata</code></a></p>"""
      )
  }
  ...
  it should "create accept also non ascii characters (java letters) in package names" in {
    markdown("@scaladoc[S0meTHing](org.example.some.stränµè.ıãß.S0meTHing)") shouldEqual
      renderedMd(
        "http://example.org/api/0.1.2/org/example/some/stränµè/ıãß/S0meTHing.html",
        "org.example.some.stränµè.ıãß.S0meTHing",
        "S0meTHing"
      )
  }
  ...
  it should "create accept subpackages starting with uppercase" in {
    ...
    markdown("@scaladoc[S0meTHing](org.example.soME.stränµè.ıãß.你好.S0meTHing)") shouldEqual
      renderedMd(
        "http://example.org/api/0.1.2/org/example/soME/stränµè/ıãß/你好/S0meTHing.html",
        "org.example.soME.stränµè.ıãß.你好.S0meTHing",
        "S0meTHing"
      )
  }
  ...
  it should "handle method links correctly" in {
    markdown("@scaladoc[???](scala.Predef$#???:Nothing)") shouldEqual
      html(
        """<p><a href="http://www.scala-lang.org/api/2.11.12/scala/Predef$.html#???:Nothing" title="scala.Predef"><code>???</code></a></p>"""
      )

    markdown("""@scaladoc:[Actor#preStart]
        |
        |  [Actor#preStart]: akka.actor.Actor#preStart():Unit""") shouldEqual
      html(
        """<p><a href="http://doc.akka.io/api/akka/2.4.10/akka/actor/Actor.html#preStart():Unit" title="akka.actor.Actor"><code>Actor#preStart</code></a></p>"""
      )
  }
  ...
  it should "handle object links correctly" in {
    ...
    markdown("@scaladoc[Actor](akka.actor.Actor)") shouldEqual
      html(
        """<p><a href="http://doc.akka.io/api/akka/2.4.10/akka/actor/Actor.html" title="akka.actor.Actor"><code>Actor</code></a></p>"""
      )
  }
  ...
  it should "handle inner classes correctly" in {
    markdown("@scaladoc[Consumer.Control](akka.kafka.scaladsl.Consumer.Control)") shouldEqual
      html(
        """<p><a href="https://doc.akka.io/api/alpakka-kafka/current/akka/kafka/scaladsl/Consumer$$Control.html" title="akka.kafka.scaladsl.Consumer.Control"><code>Consumer.Control</code></a></p>"""
      )
  }

  it should "handle inner classes in $$ notation correctly if a subpackage starts with an uppercase character" in {
    val ctx = context.andThen(c =>
      c.copy(properties =
        c.properties
  ...
  it should "retain whitespace before or after" in {
    markdown("The @scaladoc:[Model](org.example.Model) class") shouldEqual
      html(
        """<p>The <a href="http://example.org/api/0.1.2/org/example/Model.html" title="org.example.Model"><code>Model</code></a> class</p>"""
      )
  }
  ...
  it should "parse but ignore directive attributes" in {
    markdown("The @scaladoc:[Model](org.example.Model) { .scaladoc a=1 } spec") shouldEqual
      html(
        """<p>The <a href="http://example.org/api/0.1.2/org/example/Model.html" title="org.example.Model"><code>Model</code></a> spec</p>"""
      )
  }
  ...
  it should "support Scala 2.12 links" in {
    ...
    markdown("@scaladoc[Int](scala.Int)") shouldEqual
      html(
        """<p><a href="http://www.scala-lang.org/api/2.12.0/scala/Int.html" title="scala.Int"><code>Int</code></a></p>"""
      )
    markdown("@scaladoc[Codec$](scala.io.Codec$)") shouldEqual
      html(
        """<p><a href="http://www.scala-lang.org/api/2.12.0/scala/io/Codec$.html" title="scala.io.Codec"><code>Codec$</code></a></p>"""
      )
    markdown("@scaladoc[scala.io package](scala.io.index)") shouldEqual
      html(
        """<p><a href="http://www.scala-lang.org/api/2.12.0/scala/io/index.html" title="scala.io"><code>scala.io package</code></a></p>"""
      )
  }
  ...
  it should "support Scala 2.11 links" in {
    ...
    markdown("@scaladoc[Int](scala.Int)") shouldEqual
      html(
        """<p><a href="http://www.scala-lang.org/api/2.11.12/scala/Int.html" title="scala.Int"><code>Int</code></a></p>"""
      )
    markdown("@scaladoc[Codec$](scala.io.Codec$)") shouldEqual
      html(
        """<p><a href="http://www.scala-lang.org/api/2.11.12/scala/io/Codec$.html" title="scala.io.Codec"><code>Codec$</code></a></p>"""
      )
    markdown("@scaladoc[scala.io package](scala.io.package)") shouldEqual
      html(
        """<p><a href="http://www.scala-lang.org/api/2.11.12/scala/io/package.html" title="scala.io"><code>scala.io package</code></a></p>"""
      )
  }

  it should "support referenced links" in {
    markdown("""The @scaladoc:[Model][1] spec
        |
        |  [1]: org.example.Model
      """) shouldEqual
      html(
